...
the Active Record API from [Part 2](tutorial-2-models.md). `NotFoundException`
...
$CSRF"` (`cookies.txt`/`$CSRF` from [Part 1](tutorial-1-setup.md#try-the-auth-thats-already-there)),
...
You now have full CRUD for two models. What's missing: a task has no
idea which project it belongs to. Continue to
[Part 4 — Relationships](tutorial-4-relationships.md).
